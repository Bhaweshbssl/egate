...
class CouponController extends Controller
{
        ...
        if($check_coupon==0){
            ...
            if($check_status->status==0){
                ...
                if($expiried_date<$date_now){
                    ...
                    return back()->with('message_apply_sucess',' Coupon Code applied Successfully!');
                }
            }
        }
    }
    ...
    {
        $menu_active=5;
        $content = Orders_model::orderBy('created_at', 'desc')->get();
        return view('backEnd.order.list',compact('menu_active','content'));
    }
}
