...
class UsersController extends Controller
{
    ...
    public function wishcarts(){
        $userId = Auth::user()->id;
        $content = Wishlist::orderBy('created_at', 'desc')->where('user_id', '=', $userId)->get();       
        return view('users.wishlist')->with(['content'=>$content]);
    }

    public function orderhistory(){
        $userId = Auth::user()->id;
        $content = Orders_model::orderBy('created_at', 'desc')->where('users_id', '=', $userId)->get();       
        return view('users.history')->with(['content'=>$content]);
    }
}
