...
<div id="sidebar"><a href="{{url('/admin')}}" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        ...
        <li class="submenu {{$menu_active==5? ' active':''}}"> <a href="#"><i class="icon icon-th-list"></i> <span>Orders</span></a>
            <ul>
                <li><a href="{{route('orderlist')}}">List Orders</a></li>
            </ul>
        </li>
        ...
        <li class="submenu {{$menu_active==7? ' active':''}}"> <a href="#"><i class="icon icon-th-list"></i> <span>Pages</span></a>
            <ul>
                <li><a href="{{url('/admin/pages/create')}}">Add New Page</a></li>
