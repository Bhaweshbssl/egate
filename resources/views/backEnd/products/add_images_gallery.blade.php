                            ...
                            <?php $i=1; ?>
                                @foreach($imageGalleries as $imageGallery)
                                    <tr>
                                        ...
                                        <td class="taskOptions" style="text-align: center;vertical-align: middle;"><img src="{{url('public/products/small',$imageGallery->image)}}" class="img-responsive" alt="Image" width="60"></td>
