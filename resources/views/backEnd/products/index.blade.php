                ...
                <table class="table table-bordered data-table">
                    ...
                    @foreach($products as $product)
                        ...
                        <tr class="gradeC">
                            ...
                            <td style="vertical-align: middle;">{{$product->p_type}}</td>
                        ...
                        <div id="myModal{{$product->id}}" class="modal hide">
                            ...
                            <div class="modal-body">
                                <div class="text-center"><img src="{{url('public/products/small',$product->image)}}" width="100" alt="{{$product->p_code}}"></div>
