...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('userlist')}}" class="current">Users</a></div>
                ...
                <table class="table table-bordered data-table">
                    ...
                    @foreach($users as $c)
                        ...
                        <tr class="gradeC">
                            ...
                            <td style="text-align: center; vertical-align: middle;">{{$c->mobile}}</td>
